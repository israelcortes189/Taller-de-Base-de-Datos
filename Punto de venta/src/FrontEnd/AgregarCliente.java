...
public class AgregarCliente extends javax.swing.JDialog {
    private JDialog ventanaClientes;// Referencia a la ventana de productos
    
    public AgregarCliente(java.awt.Frame parent, boolean modal, JDialog ventanaClientes) {
        super(parent, modal);
        initComponents();
        this.ventanaClientes = ventanaClientes;
    }
    
    public void add(int id, String Nombre) throws SQLException{
        try {
            cliente.agregarCliente(id, Nombre);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((t2 != null && !t2.trim().isEmpty()) && (t1 != null && !t1.trim().isEmpty())) {
            ...
            clientes clientesWindow = new clientes(null,true);
            clientesWindow.setVisible(true);  // Muestra la nueva ventana
        }else{
