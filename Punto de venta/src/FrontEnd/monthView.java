 ...
 * @author erikb
 */
public class monthView extends javax.swing.JDialog {

    public monthView(Point p) {
        super();
        this.setModal(true);
    ...
    private void initComponents() {
        ...
        tMain.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Folio", "Mes", "Clave de empleado", "Nombre de empleado", "Total de ventas", "Cantidad de detalles"
            }
        ) {
        ...
        if (tMain.getColumnModel().getColumnCount() > 0) {
            ...
            tMain.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(panel, javax.swing.GroupLayout.DEFAULT_SIZE, 851, Short.MAX_VALUE)
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        Views.getView((DefaultTableModel) tMain.getModel(), 1, String.valueOf(boxMeses.getSelectedIndex()+1), txtAnio.getText());
